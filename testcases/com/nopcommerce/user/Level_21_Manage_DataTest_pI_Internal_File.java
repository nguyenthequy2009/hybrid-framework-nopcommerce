...
public class Level_21_Manage_DataTest_pI_Internal_File extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		dayOfBirth = UserData.DATE;
		monthOfBirth = UserData.MONTH;
		yearOfBirth = UserData.YEAR;
		emailAddress = UserData.EMAIL + generateFakeNumberByDateTime() + "@mail.net";
